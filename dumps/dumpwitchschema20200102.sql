...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$180000$xZqFAUMojJTf$YmUNaDYmX06UqNWY68DigupzEKtzq9iODoUkMpPoVI0=','2020-01-03 01:11:55.759224',1,'admin','','','networkteam@primerica.com',1,1,'2019-11-25 20:35:56.892799');
...
INSERT INTO `django_jstree_nodetype` VALUES (1,'ConfigItem','',-1,-1,'','',''),(2,'Folder','',-1,-1,'','','');
...
INSERT INTO `django_jstree_nodetype_jstrees` VALUES (1,1,1),(2,2,1);
...
INSERT INTO `django_jstree_nodetypepopupmenuitem` VALUES (1,0,1,5),(2,0,2,6),(4,0,2,7),(5,0,1,7),(6,0,2,8),(7,0,2,9),(8,0,2,10),(9,0,1,11);
...
CREATE TABLE `django_jstree_popupmenuitem` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `path` (`path`),
  CONSTRAINT `django_jstree_popupmenuitem_chk_1` CHECK ((`depth` >= 0)),
  CONSTRAINT `django_jstree_popupmenuitem_chk_2` CHECK ((`numchild` >= 0))
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `django_jstree_popupmenuitem` VALUES (5,'EditConfigItem','','Edit','edit-configitem','edit_configitem',1,0,'0004'),(6,'FolderCreate','','Create','folder-create','',1,2,'0003'),(7,'FolderCreateFolder','','Folder','create-folder-folder','create_folder',2,0,'00030001'),(8,'FolderCreateConfigItem','','Config Item','create-config-item','create_configitem',2,0,'00030004'),(9,'EditFolder','','Edit','edit-folder','edit_folder',1,0,'0005'),(10,'DeleteFolder','','Delete','delete-folder','delete_folder',1,0,'0006'),(11,'DeleteConfigitem','','Delete','delete-configitem','delete_configitem',1,0,'0007');
/*!40000 ALTER TABLE `django_jstree_popupmenuitem` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `django_jstree_popupmenuitem_childmenuitems`
--

DROP TABLE IF EXISTS `django_jstree_popupmenuitem_childmenuitems`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `django_jstree_popupmenuitem_childmenuitems` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `from_popupmenuitem_id` int(11) NOT NULL,
  `to_popupmenuitem_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `django_jstree_popupmenui_from_popupmenuitem_id_to_e9fc8c61_uniq` (`from_popupmenuitem_id`,`to_popupmenuitem_id`),
  KEY `django_jstree_popupm_to_popupmenuitem_id_2451c5f0_fk_django_js` (`to_popupmenuitem_id`),
  CONSTRAINT `django_jstree_popupm_from_popupmenuitem_i_e1fb8fec_fk_django_js` FOREIGN KEY (`from_popupmenuitem_id`) REFERENCES `django_jstree_popupmenuitem` (`id`),
  CONSTRAINT `django_jstree_popupm_to_popupmenuitem_id_2451c5f0_fk_django_js` FOREIGN KEY (`to_popupmenuitem_id`) REFERENCES `django_jstree_popupmenuitem` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `django_jstree_popupmenuitem_childmenuitems`
--

LOCK TABLES `django_jstree_popupmenuitem_childmenuitems` WRITE;
...
-- Dump completed on 2020-01-02 23:08:46

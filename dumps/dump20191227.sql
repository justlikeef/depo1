...
INSERT INTO `depo_configitem` VALUES (1,'A1','','ap879','ap879');
...
INSERT INTO `depo_configitemtree` VALUES ('0003',1,5,1,'Primerica','','static'),('00030005',2,2,2,'Network Devices','','static'),('00030002',2,0,3,'Desktop','','static'),('00030007',2,0,4,'Server','','static'),('00030006',2,0,5,'Operations','','static'),('00030004',2,0,6,'Facilities','','static'),('0002',1,0,7,'Incorrect','','static'),('000300050005',3,0,8,'Switches','','static'),('000300050002',3,0,9,'Routers','','static');
...
INSERT INTO `depo_configitemtree_configitems` VALUES (1,8,1);
...
INSERT INTO `django_content_type` VALUES (4,'admin','logentry'),(6,'auth','group'),(5,'auth','permission'),(7,'auth','user'),(8,'contenttypes','contenttype'),(1,'depo','configitem'),(2,'depo','configitemattribute'),(3,'depo','configitemattributevalue'),(10,'depo','configitemtree'),(11,'depo','credential'),(12,'depo','credentialset'),(13,'depo_credentials','credentialset'),(14,'django_jstree','jstree'),(15,'django_jstree','nodetype'),(9,'sessions','session');
...
CREATE TABLE `django_jstree_jstree` (
  ...
  `contextMenu` tinyint(1) NOT NULL,
...
INSERT INTO `django_jstree_jstree` VALUES (1,'ConfigItemTree','','depo','ConfigItemTree',1,1,1,0,0,0,1,1,0,'','configItems');
...
CREATE TABLE `django_jstree_nodetype` (
  ...
  PRIMARY KEY (`id`),
  KEY `django_jstree_nodety_jsTree_id_9cbf4294_fk_django_js` (`jsTree_id`),
  CONSTRAINT `django_jstree_nodety_jsTree_id_9cbf4294_fk_django_js` FOREIGN KEY (`jsTree_id`) REFERENCES `django_jstree_jstree` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-12-27 18:26:05
